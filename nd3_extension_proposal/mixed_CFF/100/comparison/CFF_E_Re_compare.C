void CFF_E_Re_compare()
{
  ...
  sprintf(psnamebig1,"CFF_ere_compare.eps");
  sprintf(gifnamebig1,"CFF_ere_compare.pdf");
  sprintf(gifnamebig2,"CFF_ere_50days.pdf");
  sprintf(psnamebig2,"CFF_ere_50days.eps");
