void flavors_compare()
{
  ...
  Double_t e_h1_d_50[4],e_h2_d_50[4],e_h1_u_50[4],e_h2_u_50[4];
  ...
  for(Int_t j=0;j<4;j++)
    {
      ...
      h2_mick_value[j]=0.5*(2*h2_mick[j]+err_m_h2_mick[j]-err_p_h2_mick[j]);
      err_h2_mick[j]=0.5*(err_m_h2_mick[j]+err_p_h2_mick[j]);
      h1_value_50[j]=0.5*(2*h1_50[j]+err_m_h1_50[j]-err_p_h1_50[j]);
      err_h1_50[j]=0.5*(err_m_h1_50[j]+err_p_h1_50[j]);
      h2_value_50[j]=0.5*(2*h2_50[j]+err_m_h2_50[j]-err_p_h2_50[j]);
      err_h2_50[j]=0.5*(err_m_h2_50[j]+err_p_h2_50[j]);
    }
  for(Int_t i=0;i<4;i++)
    {
      ...
      h1_u_50[i]=9./15.*(4*h1_mick_value[i]-h1_value_50[i]);
      h1_d_50[i]=9./15.*(4*h1_value_50[i]-h1_mick_value[i]);
      h2_u_50[i]=9./15.*(4*h2_mick_value[i]-h2_value_50[i]);
      h2_d_50[i]=9./15.*(4*h2_value_50[i]-h2_mick_value[i]);
  ...
  gr_h1_mick = new TGraphErrors(4,t_vec_50,h1_mick_value,err_t,err_h1_mick);
  gr_h2_mick = new TGraphErrors(4,t_vec_50,h2_mick_value,err_t,err_h2_mick);
  gr_h1_50 = new TGraphErrors(4,t_vec2_50,h1_50,err_t,err_h1_50);  
  gr_h2_50 = new TGraphErrors(4,t_vec2_50,h2_50,err_t,err_h2_50);
  gr_u1_50 = new TGraphErrors(4,t_vec_50,h1_u_50,err_t,e_h1_u_50);  
  gr_u2_50 = new TGraphErrors(4,t_vec_50,h2_u_50,err_t,e_h2_u_50);
  gr_d1_50 = new TGraphErrors(4,t_vec2_50,h1_d_50,err_t,e_h1_d_50);  
  gr_d2_50 = new TGraphErrors(4,t_vec2_50,h2_d_50,err_t,e_h2_d_50);
 ...
 leg2->AddEntry(gr_h1,"H_{Im}(n), 100 days", "lep");
 leg2->AddEntry(gr_h1_50,"H_{Im}(n), 50 days", "lep");
 leg2->Draw();
