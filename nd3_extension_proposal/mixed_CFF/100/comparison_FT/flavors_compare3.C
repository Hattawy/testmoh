...
gStyle->SetTitleAlign(23); 
 ...
 leg5->SetLineColor(0);
 leg5->AddEntry(gr_d1_100FT,"H_{Im}(d), 100 days", "lep");
 leg5->AddEntry(gr_d1_100noFT,"H_{Im}(d), 100 days - FT", "lep");
 leg5->AddEntry(gr_d1_50,"H_{Im}(d), 50 days", "lep");
 leg5->Draw();
 ...
 gr_d2_100noFT->GetYaxis()->SetTitle("H_{Im}(d)");
 ...
 gr_d3_100noFT->GetYaxis()->SetTitle("H_{Im}(d)");
 ...
 gr_d4_100noFT->GetYaxis()->SetTitle("H_{Im}(d)");
 ...
 leg5->SetTextSize(0.035);
 leg5->SetLineColor(0);
 leg5->AddEntry(gr_u1_100FT,"H_{Im}(u), 100 days", "lep");
 leg5->AddEntry(gr_u1_100noFT,"H_{Im}(u), 100 days - FT", "lep");
 leg5->AddEntry(gr_u1_50,"H_{Im}(u), 50 days", "lep");
 leg5->Draw();
 ...
 gr_u2_100noFT->GetYaxis()->SetTitle("H_{Im}(u)");
 ...
 gr_u3_100noFT->GetYaxis()->SetTitle("H_{Im}(u)");
 ...
 gr_u4_100noFT->GetYaxis()->SetTitle("H_{Im}(u)");
