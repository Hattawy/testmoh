...
gStyle->SetTitleAlign(23); 
  ...
  Double_t h1_100FT[4]={1.25749,0.424465,0.303106,0.179397};
  Double_t err_h1_100FT[4]={2.05426,0.287058,0.107648,0.0559166};

  Double_t h2_100FT[4]={-0.647902,-0.149609,-0.0107133,0.0520024};
  Double_t err_h2_100FT[4]={3.64692,1.21246,0.48032,0.200542};

  Double_t h3_100FT[4]={0.069827,0.266045,0.293017,0.169148};
  Double_t err_h3_100FT[4]={1.49324,0.303968,0.202149,0.138201};

  Double_t h4_100FT[4]={0.149485,0.107274,0.175863,0.145436};
  Double_t err_h4_100FT[4]={2.10327,0.696139,0.221655,0.122901};

  Double_t h1_100noFT[4]={1.24852,0.450697,0.316259,0.201035};
  Double_t err_h1_100noFT[4]={2.09539,0.307991,0.168811,0.09665593};

  Double_t h2_100noFT[4]={-0.596876,-0.155339,-0.0253067,0.0753646};
  Double_t err_h2_100noFT[4]={3.59616,1.21494,0.525003,0.235727};

  Double_t h3_100noFT[4]={-2.41638,0.329006,0.372629,0.17062};
  Double_t err_h3_100noFT[4]={3.55673,0.623538,0.302076,0.155252};

  Double_t h4_100noFT[4]={1.24852,0.450697,0.316259,0.201035};
  Double_t err_h4_100noFT[4]={2.09539,0.307991,0.168811,0.0966559};
  ...
  gr_u1_100noFT = new TGraphErrors(4,t_vec2,h1_u_100noFT,err_t,e_h1_u_100noFT);  
  gr_u2_100noFT = new TGraphErrors(4,t_vec2,h2_u_100noFT,err_t,e_h2_u_100noFT);
  gr_u3_100noFT = new TGraphErrors(4,t_vec2,h3_u_100noFT,err_t,e_h3_u_100noFT);  
  gr_u4_100noFT = new TGraphErrors(4,t_vec2,h4_u_100noFT,err_t,e_h4_u_100noFT);
  gr_d1_100noFT = new TGraphErrors(4,t_vec2,h1_d_100noFT,err_t,e_h1_d_100noFT);  
  gr_d2_100noFT = new TGraphErrors(4,t_vec2,h2_d_100noFT,err_t,e_h2_d_100noFT);
  gr_d3_100noFT = new TGraphErrors(4,t_vec2,h3_d_100noFT,err_t,e_h3_d_100noFT);  
  gr_d4_100noFT = new TGraphErrors(4,t_vec2,h4_d_100noFT,err_t,e_h4_d_100noFT);
  ...
  gr_h1_100noFT->SetLineColor(1);
  gr_h1_100noFT->SetMarkerColor(1);
 ...
 leg->AddEntry(gr_h1_100FT,"E_{Im}(n), 100 days - FT", "lep");
 leg->AddEntry(gr_h1_100noFT,"E_{Im}(n), 100 days - no FT", "lep");
 leg->AddEntry(gr_h1_50,"E_{Im}(n), 50 days", "lep");
 leg->Draw();
  ...
  gr_h2_100noFT->SetLineColor(1);
  gr_h2_100noFT->SetMarkerColor(1);
 ...
 // leg2->AddEntry(gr_h2_100FT,"E_{Im}(n), 100 days - FT", "lep");
 // leg2->AddEntry(gr_h2_100noFT,"E_{Im}(n), 100 days - no FT", "lep");
 // leg2->AddEntry(gr_h2_50,"E_{Im}(n), 50 days", "lep");
 // leg2->Draw();
  ...
  gr_h3_100noFT->SetLineColor(1);
  gr_h3_100noFT->SetMarkerColor(1);
 ...
 // leg3->AddEntry(gr_h3_100FT,"E_{Im}(n), 100 days - FT", "lep");
 // leg3->AddEntry(gr_h3_100noFT,"E_{Im}(n), 100 days - no FT", "lep");
 // leg3->AddEntry(gr_h3_50,"E_{Im}(n), 50 days", "lep");
 // leg3->Draw();
  ...
  gr_h4_100noFT->SetLineColor(1);
  gr_h4_100noFT->SetMarkerColor(1);
 ...
 // leg4->AddEntry(gr_h4_100FT,"E_{Im}(n), 100 days - FT", "lep");
 // leg4->AddEntry(gr_h4_100noFT,"E_{Im}(n), 100 days - no FT", "lep");
 // leg4->AddEntry(gr_h4_50,"E_{Im}(n), 50 days", "lep");
 // leg4->Draw();
 ...
 gr_d1_100noFT->SetTitle();
 gr_d1_100noFT->SetMarkerStyle(26);
 gr_d1_100noFT->SetMarkerSize(0.5);
 gr_d1_100noFT->SetLineColor(1);
 gr_d1_100noFT->SetMarkerColor(1);
 gr_d1_100noFT->Draw("P,same");
 gr_d1_50->SetTitle();
 ...
 leg5->SetLineColor(0);
 leg5->AddEntry(gr_d1_100FT,"E_{Im}(d), 100 days", "lep");
 leg5->AddEntry(gr_d1_100noFT,"E_{Im}(d), 100 days - FT", "lep");
 leg5->AddEntry(gr_d1_50,"E_{Im}(d), 50 days", "lep");
 leg5->Draw();
 ...
 gr_d2_100noFT->SetMarkerStyle(26);
 gr_d2_100noFT->SetMarkerSize(0.5);
 gr_d2_100noFT->SetLineColor(1);
 gr_d2_100noFT->SetMarkerColor(1);
 gr_d2_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_d2_100noFT->GetYaxis()->SetTitle("E_{Im}(d)");
 gr_d2_100noFT->Draw("P,same");
 ...
 gr_d3_100noFT->SetMarkerStyle(26);
 gr_d3_100noFT->SetMarkerSize(0.5);
 gr_d3_100noFT->SetLineColor(1);
 gr_d3_100noFT->SetMarkerColor(1);
 gr_d3_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_d3_100noFT->GetYaxis()->SetTitle("E_{Im}(d)");
 gr_d3_100noFT->Draw("P,same");
 ...
 gr_d4_100noFT->SetMarkerStyle(26);
 gr_d4_100noFT->SetMarkerSize(0.5);
 gr_d4_100noFT->SetLineColor(1);
 gr_d4_100noFT->SetMarkerColor(1);
 gr_d4_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_d4_100noFT->GetYaxis()->SetTitle("E_{Im}(d)");
 gr_d4_100noFT->Draw("P,same");
 ...
 gr_u1_100noFT->SetTitle();
 gr_u1_100noFT->SetMarkerStyle(26);
 gr_u1_100noFT->SetMarkerSize(0.5);
 gr_u1_100noFT->SetLineColor(1);
 gr_u1_100noFT->SetMarkerColor(1);
 gr_u1_100noFT->Draw("P,same");
 gr_u1_50->SetTitle();
 ...
 leg5->SetTextSize(0.035);
 leg5->SetLineColor(0);
 leg5->AddEntry(gr_u1_100FT,"E_{Im}(u), 100 days", "lep");
 leg5->AddEntry(gr_u1_100noFT,"E_{Im}(u), 100 days - FT", "lep");
 leg5->AddEntry(gr_u1_50,"E_{Im}(u), 50 days", "lep");
 leg5->Draw();
 ...
 gr_u2_100noFT->SetMarkerStyle(26);
 gr_u2_100noFT->SetMarkerSize(0.5);
 gr_u2_100noFT->SetLineColor(1);
 gr_u2_100noFT->SetMarkerColor(1);
 gr_u2_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_u2_100noFT->GetYaxis()->SetTitle("E_{Im}(u)");
 gr_u2_100noFT->Draw("P,same");
 ...
 gr_u3_100noFT->SetMarkerStyle(26);
 gr_u3_100noFT->SetMarkerSize(0.5);
 gr_u3_100noFT->SetLineColor(1);
 gr_u3_100noFT->SetMarkerColor(1);
 gr_u3_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_u3_100noFT->GetYaxis()->SetTitle("E_{Im}(u)");
 gr_u3_100noFT->Draw("P,same");
 ...
 gr_u4_100noFT->SetMarkerStyle(26);
 gr_u4_100noFT->SetMarkerSize(0.5);
 gr_u4_100noFT->SetLineColor(1);
 gr_u4_100noFT->SetMarkerColor(1);
 gr_u4_100noFT->GetXaxis()->SetTitle("-t (GeV^{2})");
 gr_u4_100noFT->GetYaxis()->SetTitle("E_{Im}(u)");
 gr_u4_100noFT->Draw("P,same");
