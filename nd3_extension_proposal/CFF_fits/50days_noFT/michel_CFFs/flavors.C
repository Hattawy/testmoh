void flavors()
{
  ...
  Double_t h1[4]={1.54095,0.702571,0.227825,0.0641715};
  Double_t err_p_h1[4]={0.28316,0.18143,0.510573,0.187421};
  Double_t err_m_h1[4]={1.99211,0.206266,0.158289,0.116733};

  Double_t h2[4]={-100.,0.889978,0.444782,0.194196};
  Double_t err_p_h2[4]={0.,0.384681,0.234238,0.313655};
  Double_t err_m_h2[4]={0.,0.194196,0.313655,0.213819};
  ...
  gr_u1 = new TGraphAsymmErrors(4,t_vec,h1_u,err_t,err_t,e_p_h1_u,e_m_h1_u);
  
  gr_u2 = new TGraphAsymmErrors(4,t_vec,h2_u,err_t,err_t,e_p_h2_u,e_m_h2_u);
