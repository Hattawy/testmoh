...
gStyle->SetFrameFillColor(kWhite);
 ...
 Float_t X1[4][4][4][12], UPUP1[4][4][4][12],UPDN1[4][4][4][12], DNUP1[4][4][4][12],DNDN1[4][4][4][12],TOT1[4][4][4][12],A1[4][4][4][12],err[4][4][4][12],COUNTS[4][4][4][12],NPLUS[4][4][4][12],NMINUS[4][4][4][12],DNPLUS[4][4][4][12],DNMINUS[4][4][4][12];
 ...
 sprintf(canvas,"g1");
 sprintf(psnamebig,"asym_newcuts_newerr_test.eps");
 sprintf(gifnamebig,"asym_newcuts_newerr_test.jpg");
	 ...
	 for(Int_t k=1;k<NT+1;k++)
	   {
		 ...
		 if(COUNTS[j-1][i-1][k-1][l-1]!=0)
		   {
		     NPLUS[j-1][i-1][k-1][l-1]=(COUNTS[j-1][i-1][k-1][l-1]+A1[j-1][i-1][k-1][l-1]*COUNTS[j-1][i-1][k-1][l-1])/2;
		     NMINUS[j-1][i-1][k-1][l-1]=(COUNTS[j-1][i-1][k-1][l-1]-A1[j-1][i-1][k-1][l-1]*COUNTS[j-1][i-1][k-1][l-1])/2;
		     DNPLUS[j-1][i-1][k-1][l-1]=TMath::Sqrt(NPLUS[j-1][i-1][k-1][l-1]);
		     DNMINUS[j-1][i-1][k-1][l-1]=TMath::Sqrt(NMINUS[j-1][i-1][k-1][l-1]);
		     err[j-1][i-1][k-1][l-1]=(2/pol)*TMath::Sqrt((NMINUS[j-1][i-1][k-1][l-1]*NMINUS[j-1][i-1][k-1][l-1]*DNPLUS[j-1][i-1][k-1][l-1]*DNPLUS[j-1][i-1][k-1][l-1]+NPLUS[j-1][i-1][k-1][l-1]*NPLUS[j-1][i-1][k-1][l-1]*DNMINUS[j-1][i-1][k-1][l-1]*DNMINUS[j-1][i-1][k-1][l-1]))/((NPLUS[j-1][i-1][k-1][l-1]+NMINUS[j-1][i-1][k-1][l-1])*(NPLUS[j-1][i-1][k-1][l-1]+NMINUS[j-1][i-1][k-1][l-1]));
		   }
		 ...
		 if(A1[j-1][i-1][k-1][l-1]!=0)
		   {cout<<"err "<<err[j-1][i-1][k-1][l-1]<<endl;
		 cout<<"A1 "<<A1[j-1][i-1][k-1][l-1]<<endl;
		 cout<<"Counts "<<COUNTS[j-1][i-1][k-1][l-1]<<endl;
		 cout<<"Nplus "<<NPLUS[j-1][i-1][k-1][l-1]<<endl;
		 cout<<"Nminus "<<NMINUS[j-1][i-1][k-1][l-1]<<endl;
		   }
	       }
